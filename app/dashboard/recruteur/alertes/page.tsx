...
function iconFor(type: string) {
  if (type === "MESSAGE_RECEIVED") return { Icon: HiOutlineChatBubbleLeftRight, bg: "bg-indigo-50", color: "text-indigo-500" };
  if (type === "APPLICATION_RECEIVED") return { Icon: HiOutlineUserGroup, bg: "bg-[#00b8d9]/10", color: "text-[#00b8d9]" };
  if (type === "JOB_MATCH") return { Icon: HiOutlineBriefcase, bg: "bg-amber-50", color: "text-amber-500" };
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-1">Les nouvelles candidatures et messages apparaîtront ici.</p>
        </div>
      ) : (
